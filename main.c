...
int main(void)
{
	...
	printf("ave_relocation:%f,ave_gap:%f,max_gap:%d,ave_time:%f,max_time:%f,\n", (double)sum / (100 * TIER), (double)gap / (100 * TIER), max_gap, (double)time / (100 * TIER * CLOCKS_PER_SEC), max_time / CLOCKS_PER_SEC);
	return 0;
}
